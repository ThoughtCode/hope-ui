            ...
            <Grid container alignItems="center" className={cls.CardJob}>
                ...
                <Grid item xs={12} sm={6}>
                    <Paper className={`${cls.pageButtonJobCurrentDetalles} ${classes.paper}`}>
                        <Grid container align="center">
                            <Grid item xs={12}>
                                <Button className={cls.ButtonDetalles} fullWidth component={Link} to="/agente/dashboard/detalles">VER DETALLES</Button>
                            </Grid>
                        </Grid>
                    </Paper>
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                    <Paper className={`${cls.pageButtonJobCurrentCancelar} ${classes.paper}`}>
                        <Grid container align="center">
                            <Grid item xs={12}>
                                <Button variant="contained" className={cls.ButtonCancelar} fullWidth >APLICAR</Button>
                            </Grid>
                        </Grid>
                    </Paper>
                </Grid>
