              ...
              <div className={cls.jobBodyWrapper}>
                <div className={cls.jobServicesWrapper}>
                  ...
                  <div className={cls.jobAddress}>
                    ...
                    {moment(props.job.attributes.started_at).format('MMMM D YYYY h:mm a').replace(/\b\w/g, l => l.toUpperCase())}/
                    {moment(props.job.attributes.finished_at).format('h:mm a').replace(/\b\w/g, l => l.toUpperCase())}
                  </div>  
